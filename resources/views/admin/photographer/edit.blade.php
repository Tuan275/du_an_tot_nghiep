...
@section('title', 'Update Photographer')
@section('content_title', 'Update Photographer')
@section('content')
    <div class="rounded max-w-lg mx-auto mt-5">
        <form action="{{route('admin.photographer.update', $photographer->id)}}" method="POST"  enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-6">
