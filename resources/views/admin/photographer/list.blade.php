        ...
        <tbody>
            @foreach ($photographer as $key => $Photographer)
                <tr>
                    ...
                    <td><img width="100" src="../../../{{$Photographer->image}}" alt=""></td>
                    ...
                    <td><button class="btn btn-primary">
                        ...
                        <button class="btn btn-danger">
                            <a class="text-white"
                            onclick="return confirm('Really delete this photographer?')"
                            href="{{route('admin.photographer.delete', $Photographer->id)}}"> Delete</a>
                        </button>
                    </td>
                </tr>
            @endforeach
