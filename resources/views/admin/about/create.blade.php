...
@section('title', 'Create About Studio')
@section('content_title', 'Create About Studio')
@section('content')
<div class="rounded max-w-lg mx-auto mt-5">
    <form method="POST" action="{{route('admin.about.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="file" class="border border-gray-200 rounded p-2 w-full" name="image" multiple="multiple" />
        ...
        <div class="mb-6">
            ...
            <textarea type="file" class="border border-gray-200 rounded p-2 w-full ckeditor" name="description" multiple="multiple"></textarea>
