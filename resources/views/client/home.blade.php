...
<div class="grid">
    ...
    <div class="py-5 bg-[#333] border-b border-white">
        <div class="container flex gap-5 items-center">
            <div class="w-[50%]">
                <img width="100" class="w-full h-[full]" src="../../../{{ $items->image }}" alt="">
            </div>
