...
<head>
    ...
    <!-- Add these lines in the <head> section of your master layout (e.g., master.blade.php) -->
    ...
    <style>
        * {
        ...
        .slider-content {
            ...
            /* Màu nền cho văn bản */
            padding: 10px 20px;
            /* Khoảng cách giữa văn bản và khung nền */
            border-radius: 5px;
            /* Bo tròn góc khung nền */
            max-width: 80%;
            /* Giới hạn chiều rộng của văn bản */
            margin: 0 auto;
            /* Căn giữa văn bản */
        }
